...
Главное меню предоставляет доступ ко всем функциям установщика. Пункты меню видны на скриншоте выше.

### Меню установки

Меню установки предлагает различные сценарии развертывания компонентов Remnawave.
